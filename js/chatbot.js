$(document).ready(function() {
	...
	/* Radheshyam's server creditional */
	/* DO NOT CHANGE */
	var baseUrl = "https://api.api.ai/v1/query?v=20160910&";
	var accessToken = "b28bdd73a90f4cbd81971f71e783ba48";

	//---------------------------------- Add dynamic html bot content(Widget style) ----------------------------	
	var mybot = '<div class="chatCont chatbody" id="chatCont">'+
								'<div class="bot_profile">'+
									'<i id="toggleChat" class="fa fa-times" aria-hidden="true"><img src="images/chat_bot_female.png" class="bot_p_img"></i>'+
									'<div class="close">'+
								...
								'<div class="chatForm" id="chat-div">'+
									...
									'<p id="test" class="poweredBy"> <strong> @ Powered by - CloudCore Innovations</strong></p>' +
								'</div>'+
							'</div><!--chatCont end-->'+
							...
							'<div class="profile_div">'+
								'<div class="row">'+
									'<div class="col-hgt">'+
										'<img src="images/chat_bot_female.png" class="img-circle img-profile">'+
									'</div><!--col-hgt end-->'+
									'<div class="col-hgt">'+	
									'<div class="chat-txt">'+
											'Chat with us now!'+
